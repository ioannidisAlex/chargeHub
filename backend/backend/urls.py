...
urlpatterns = [
    ...
    path('admin/resetsessions/', api_views.ResetSessionsView.as_view(), name='resetsessions'),
    path('admin/healthcheck/', api_views.HealthcheckView.as_view(), name='healthcheck'),
    path('SessionsPerPoint/<str:id>/<str:date_from>/<str:date_to>/', api_views.SessionsPerPointView.as_view(), name='sessions_per_point'),
    path('SessionsPerStation/<str:id>/<str:date_from>/<str:date_to>/', api_views.SessionsPerStationView.as_view(), name='sessions_per_station'),
    ...
    path('SessionsPerProvider/<str:id>/<str:date_from>/<str:date_to>/', api_views.SessionsPerProviderView.as_view(), name='sessions_per_provider'),
    path('admin/', admin.site.urls),
    path("example/", api_views.ExampleView.as_view(), name="example"),
    path('generate_csrf/', api_views.CSRFGeneratorView.as_view()),
    path('rest_login/', api_views.CustomAuthToken.as_view(), name='rest_login'),
    path("rest_logout/", api_views.LogoutView.as_view(), name="rest_logout"),
    path('api/', include(router.urls)),
    path('api/usermod/', api_views.UsermodAPIView.as_view(), name='usermod'),
