...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    multiselectfield.db.fields.MultiSelectField(
                        choices=[("type1", "Type1"), ("type2", "Type2")], max_length=5
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_id",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="common.session"
                    ),
                ),
                (
                    "user_id",
        ...
        migrations.AddField(
            ...
            name="location",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="common.location"
            ),
        ),
    ]
